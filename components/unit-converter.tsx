...
export default function UnitConverter() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-rose-100 dark:bg-gray-900 px-5">
      <div className="max-w-md w-full p-6 bg-card rounded-lg shadow-lg bg-amber-100">
